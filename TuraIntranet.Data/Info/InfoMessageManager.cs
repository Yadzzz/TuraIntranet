...
namespace TuraIntranet.Data.Info
{
    public class InfoMessageManager
    {
        ...
        public async Task<List<InfoMessageModel>?> GetInfoMessagesAsync()
        {
            ...
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/InfoMessages");
        ...
        public async Task<InfoMessageModel?> GetInfoMessageAsync(int id)
        {
            ...
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/InfoMessages/" + id);
