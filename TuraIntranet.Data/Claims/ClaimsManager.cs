...
namespace TuraIntranet.Data.Claims
{
    public class ClaimsManager
    {
        ...
        public async Task<Claim> GetClaim(int id)
        {
            ...
            APIRequest api = new APIRequest("/api/v1/intranet/claims/Claims/" + id);
        ...
        public async Task<List<Claim>> GetClaimsAsync()
        {
            ...
            APIRequest api = new APIRequest("/api/v1/intranet/claims/Claims");
        ...
        public async Task<List<ClaimCurrency>> GetCurrenciesAsync()
        {
            ...
            APIRequest api = new APIRequest("/api/v1/intranet/claims/ClaimCurrencies");
        ...
        public async Task<ClaimCurrency> GetCurrencyAsync(int id)
        {
            ...
            APIRequest api = new APIRequest("/api/v1/intranet/claims/ClaimCurrencies/" + id);
        ...
        {
            APIRequest api = new APIRequest("/api/v1/intranet/claims/Claims/" + claim.Id);
