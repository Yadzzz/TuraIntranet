...
namespace TuraIntranet.Data.Backoffice.Koss
{
    public class KossManager
    {
        ...
        public async Task<List<KossRma>> GetKossRmasAsync()
        {
            ...
            APIRequest api = new APIRequest("https://apitest.turascandinavia.com/api/v1/koss/KossRmas");
        ...
        public async Task<KossRma> GetKossRmaAsync(int id)
        {
            ...
            APIRequest api = new APIRequest("https://apitest.turascandinavia.com/api/v1/koss/KossRmas/" + id);
        ...
        public async Task<List<KossHeadphoneModel>?> GetKossModelsAsync()
        {
            ...
            APIRequest api = new APIRequest("https://apitest.turascandinavia.com/api/v1/koss/KossHeadphoneModels");
        ...
        {
            APIRequest api = new APIRequest("https://apitest.turascandinavia.com/api/v1/koss/KossRmas/" + kossRma.Id);
