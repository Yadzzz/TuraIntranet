...
namespace TuraIntranet.Data.Backoffice.Koss
{
    public class KossManager
    {
        ...
        public async Task<KossRma> GetKossRmaAsync(int id)
        {
            ...
            APIRequest api = new APIRequest("https://localhost:7245/api/v1/koss/KossRmas/" + id);
        ...
        {
            APIRequest api = new APIRequest("https://localhost:7245/api/v1/koss/KossRmas/" + kossRma.Id);
