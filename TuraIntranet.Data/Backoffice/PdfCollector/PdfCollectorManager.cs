...
namespace TuraIntranet.Data.Backoffice.PdfCollector
{
    public class PdfCollectorManager
    {
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaInvoices/getdocuments/" + customerNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaFinanceChrgs/getdocument/" + invoiceNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaFinanceChrgs/getdocuments/" + customerNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaLeveransbeks/getdocument/" + invoiceNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaLeveransbeks/getdocuments/" + customerNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaOrderbeks/getdocument/" + invoiceNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaOrderbeks/getdocuments/" + customerNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaReturorders/getdocument/" + invoiceNumber + "/" + start + "/" + end);
        ...
        {
            APIRequest api = new("/api/v1/intranet/pdfarchive/MetaReturorders/getdocuments/" + customerNumber + "/" + start + "/" + end);
