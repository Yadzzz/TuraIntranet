...
namespace TuraIntranet.Data.Logistics.Orders
{
    public class OrdersManager
    {
        ...
        public async Task<List<R08T1>> GetOrdersAsync()
        {
            ...
            APIRequest api = new APIRequest("https://apitest.turascandinavia.com/api/v1/intranet/logistics/orders/Orders");
        ...
        {
            APIRequest api = new APIRequest("https://apitest.turascandinavia.com/api/v1/intranet/logistics/orders/Orders/" + id + "/" + type);
