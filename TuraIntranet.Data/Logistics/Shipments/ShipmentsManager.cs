...
namespace TuraIntranet.Data.Logistics.Shipments
{
    public class ShipmentsManager
    {
        ...
        public async Task<List<ShipmentModel>?> GetShipments(bool forceFlush = false)
        {
            ...
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/Shipments");
        ...
        public async Task<ShipmentModel?> GetShipment(int id)
        {
            ...
            if(shipment == null)
            {
                APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/Shipments/" + id);
        ...
        public async Task<List<ShipmentEmployee>?> GetShipmentEmployees()
        {
            ...
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/ShipmentEmployee");
        ...
        {
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/ShipmentUpdate/");
        ...
        public async Task<List<ShipmentReceivingCompany>?> GetShipmentReceivingCompanies()
        {
            ...
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/ShipmentReceivingCompany");
        ...
        public async Task<List<ShipmentStatus>?> GetShipmentStatuses()
        {
            ...
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/ShipmentStatus");
        ...
        {
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/ShipmentDeviations");
            bool success = await api.SendPostRequest(deviation);
        }

        public async Task UpdateDeviation(ShipmentDeviationData deviation)
        {
            APIRequest api = new APIRequest("https://prodapi.turascandinavia.com/api/v1/intranet/logistics/shipments/ShipmentDeviations/" + deviation.ShipmentId);
