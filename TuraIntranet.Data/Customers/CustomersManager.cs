...
namespace TuraIntranet.Data.Customers
{
    public class CustomersManager
    {
        ...
        public async Task<List<SpecialCustomerModel>?> GetSpecialCustomersAsync(bool forceFlush = false)
        {
            ...
            APIRequest api = new APIRequest("/api/v1/intranet/customers/SpecialCustomers");
        ...
        public async Task<SpecialCustomerModel?> GetSpecialCustomerAsync(string id)
        {
            ...
            APIRequest api = new APIRequest("/api/v1/intranet/customers/SpecialCustomers/" + id);
        ...
        {
            APIRequest api = new APIRequest("/api/v1/intranet/customers/Customers/" + id);
        ...
        {
            APIRequest api = new APIRequest("/api/v1/intranet/customers/Customers/getbyname/" + name);
        ...
        {
            APIRequest api = new APIRequest("/api/v1/intranet/customers/Customers/getbypostalcode/" + postalCode);
        ...
        {
            APIRequest api = new APIRequest("/api/v1/intranet/customers/Customers/getbycity/" + city);
